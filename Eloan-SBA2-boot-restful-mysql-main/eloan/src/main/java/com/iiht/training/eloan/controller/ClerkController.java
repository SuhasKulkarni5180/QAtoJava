...
public class ClerkController {
	...
	public ResponseEntity<List<LoanOutputDto>> allAppliedLoans() {
        ...
        headers.add("Responded", "ClerkController");
	...
	public ResponseEntity<ProcessingDto> processLoan(@PathVariable Long clerkId,
		...
		ProcessingDto processDto= this.clerkService.processLoan(clerkId, loanAppId, processingDto);
		HttpHeaders headers = new HttpHeaders();
        headers.add("Responded", "ClerkController");
        
        return ResponseEntity.accepted().headers(headers).body(processDto);
